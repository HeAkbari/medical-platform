    ...
    <div className="space-y-6 pb-4">
      <header>
        ...
        <p className="mt-2 text-sm text-slate-600">
          Your health services and NHS information in one place.
        </p>
      </header>

      <section aria-labelledby="home-services-heading">
        <h2 id="home-services-heading" className="mb-3 text-sm font-semibold text-slate-800">
          Services
        </h2>
      ...
      <section aria-labelledby="home-support-heading">
        <h2 id="home-support-heading" className="mb-3 text-sm font-semibold text-slate-800">
